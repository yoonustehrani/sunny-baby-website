<div>
    @switch($style)
        @case("hover")
            @unless($inCart)
                <button type="button" x-on:click="$dispatch('add-to-cart', {productId: '{{ $product->id }}'})"
        ...
        <div class="tw:w-full tw:flex tw:items-center tw:justify-center">
            ...
            <div
                ...
                <button type="button" wire:click='sub'
                    class="tw:h-9 tw:w-9 tw:p-2 tw:grid tw:place-content-center tw:aspect-square">-</button>
                <div class="tw:max-h-full">
                    <input type="text"
                        class="tw:bg-gray-100 tw:text-gray-800 tw:h-6 tw:w-8 tw:text-center tw:p-0 tw:m-0"
            ...
            @else
            <button x-on:click="$dispatch('add-to-cart', {productId: '{{ $product->id }}'})"
