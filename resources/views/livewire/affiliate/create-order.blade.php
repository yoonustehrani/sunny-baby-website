            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                <div>
                    <div class="relative">
                        ...
                        <input type="text" wire:model.live.debounce.300ms='search' placeholder="@lang('Search')..." class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-10 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pr-4 pl-[42px] text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden xl:w-[300px] dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">
                    </div>
                    <x-error name="search"/>
                </div>
