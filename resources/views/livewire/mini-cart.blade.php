            ...
            <div class="tf-mini-cart-wrap">
                <div class="tf-mini-cart-main">
                    <div class="tf-mini-cart-sroll">
                        <div class="tf-mini-cart-items">
                            ...
                            <livewire:mini-cart-item :key="$item['product']['id'] . $item['quantity']" :product="$item['product']"
                ...
                <div class="tf-mini-cart-tool-openable add-note">
                    ...
                    <div class="tf-mini-cart-tool-content">
                        ...
                        <div class="tf-cart-tool-btns justify-content-center">
                            <div class="tf-mini-cart-tool-primary text-center w-100 fw-6 tf-mini-cart-tool-close">Close
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tf-mini-cart-tool-openable estimate-shipping">
                    ...
                    <div class="tf-mini-cart-tool-content">
                        ...
                        <div class="field">
                            <p>Country</p>
                            <select class="tf-select w-100" id="ShippingCountry_CartDrawer-Form" name="address[country]"
                                data-default="">
                        ...
                        <div class="tf-cart-tool-btns">
                            ...
                            <div class="tf-mini-cart-tool-primary text-center fw-6 w-100 tf-mini-cart-tool-close">Cancel
                            </div>
                        </div>
                    </div>
                </div>
