...
<div class="modal fullRight fade modal-shopping-cart" id="shoppingCart">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="header">
                <div class="title fw-5">@lang('Shopping cart')</div>
                ...
                <div class="tf-mini-cart-wrap">
                        ...
                        <div class="tf-mini-cart-sroll">
                            <div class="tf-mini-cart-items">
                                ...
                                <div class="tf-mini-cart-item">
                                    <div class="tf-mini-cart-image">
                                        <a href="product-detail.html">
                                            <img src="{{ asset('images/products/photo-7.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="tf-mini-cart-info">
                                    ...
                                    <div class="swiper-wrapper" >
                                        <div class="swiper-slide">
                                            <div class="tf-minicart-recommendations-item">
                                                <div class="tf-minicart-recommendations-item-image">
                                                    <a href="product-detail.html">
                                                        <img src="{{ asset('images/products/photo-5.jpg') }}" alt="">
                                                    </a>
                                                </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-minicart-recommendations-item">
                                                <div class="tf-minicart-recommendations-item-image">
                                                    <a href="product-detail.html">
                                                        <img src="{{ asset('images/products/photo-6.jpg') }}" alt="">
                                                    </a>
                                                </div>
                                                <div class="tf-minicart-recommendations-item-infos flex-grow-1">
                    ...
                    <div class="tf-mini-cart-bottom">
                        ...
                        <div class="tf-mini-cart-bottom-wrap">
                            <div class="tf-cart-totals-discounts">
                                ...
                                <div class="tf-totals-total-value fw-6">۵۰۰/۰۰۰ تومان</div>
                            </div>
                            ...
                            {{-- <div class="tf-cart-checkbox">
                                ...
                                <label for="CartDrawer-Form_agree">
                                    I agree with the 
                                    <a href="index.html#" title="Terms of Service">terms and conditions</a>
                                </label>
                            </div> --}}
                            <div class="tf-mini-cart-view-checkout">
                                <a href="view-cart.html" class="tf-btn btn-outline radius-3 link w-100 justify-content-center">@lang("View cart")</a>
                                <a href="checkout.html" class="tf-btn btn-fill animate-hover-btn radius-3 w-100 justify-content-center"><span>@lang("Check out")</span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tf-mini-cart-tool-openable estimate-shipping">
                        ...
                        <div class="tf-mini-cart-tool-content">
                            ...
                            <div class="tf-cart-tool-btns">
                                <a href="index.html#" class="tf-btn fw-6 justify-content-center btn-fill w-100 animate-hover-btn radius-3"><span>Estimate</span></a>
