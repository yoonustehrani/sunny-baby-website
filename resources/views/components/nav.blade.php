<nav class="box-navigation text-center">
    <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
        <li class="menu-item">
            <a href="{{ route('home') }}" class="item-link">@lang("Home")</a>
        </li>
        {{-- <li class="menu-item"><a href="{{ route('pages.contact') }}" class="item-link">@lang('Contact Us')</a></li> --}}
        {{-- <li class="menu-item">
            <a href="index.html#" class="item-link">@lang("Shop")<i class="icon icon-arrow-down"></i></a>
        ...
        <li class="menu-item">
            <a href="index.html#" class="item-link">@lang("Products")<i class="icon icon-arrow-down"></i></a>
            <div class="sub-menu mega-menu">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-2">
                                    ...
                                    <div class="swiper-wrapper">
                                            ...
                                            <div class="card-product">
                                                <div class="card-product-wrapper">
                                                    ...
                                                    <div class="list-product-btn">
                                                        <a href="index.html#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                        ...
                                                        <a href="index.html#compare" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft" class="box-icon bg_white compare btn-icon-action">
                                                            <span class="icon icon-compare"></span>
                                                            <span class="tooltip">Add to Compare</span>
                                                            <span class="icon icon-check"></span>
                                                        </a>
                                                        <a href="index.html#quick_view" data-bs-toggle="modal" class="box-icon bg_white quickview tf-btn-loading">
                                                ...
                                                <div class="card-product-info">
                                                    <a href="index.html#" class="title link">Ribbed Tank Top</a>
                                            ...
                                            <div class="card-product">
                                                <div class="card-product-wrapper">
                                                    ...
                                                    <div class="list-product-btn absolute-2">
                                                        <a href="index.html#shoppingCart" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                            <span class="icon icon-bag"></span>
                                                ...
                                                <div class="card-product-info">
                                                    <a href="index.html#" class="title link">Oversized Printed T-shirt</a>
                                        ...
                                        <div class="swiper-slide" lazy="true">
                                            <div class="card-product">
                                                ...
                                                <div class="card-product-info">
                                                    <a href="index.html#" class="title">Oversized Printed T-shirt</a>
                                                    <span class="price">$16.95</span>
                                                    <ul class="list-color-product">
                                                        <li class="list-color-item color-swatch active">
                                                            <span class="tooltip">White</span>
                                        ...
                                        <div class="swiper-slide" lazy="true">
                                            <div class="card-product">
                                                ...
                                                <div class="card-product-info">
                                                    <a href="index.html#" class="title link">V-neck linen T-shirt</a>
        ...
        <li class="menu-item position-relative">
            <a href="index.html#" class="item-link">@lang('Pages')<i class="icon icon-arrow-down"></i></a>
        ...
        <li class="menu-item position-relative">
            <a href="index.html#" class="item-link">Blog<i class="icon icon-arrow-down"></i></a>
            <div class="sub-menu submenu-default">
                <ul class="menu-list">
