...
<html lang="fa">
  <head>
    ...
    <title>{{ $title ?? __('Affiliate Panel') }}</title>
  </head>
  <body
    dir="rtl"
    x-data="{ page: 'comingSoon', 'loaded': false, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }"
    x-init="
      ...
      >
        ...
        <div class="flex flex-col flex-1 w-full lg:w-1/2">
          <div class="w-full max-w-md pt-10 mx-auto">
            <a
              href="{{ route('home') }}"
              class="inline-flex gap-2 items-center text-sm text-gray-500 transition-colors hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300"
            >
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/>
                </svg>
                <span>بازگشت به صفحه اصلی وب سایت</span>
            </a>
          </div>
          {{ $slot }}
        </div>
          ...
          <div class="flex items-center justify-center z-1">
            ...
            <div class="flex flex-col items-center max-w-xs">
              <a href="{{ route('home') }}" class="block mb-4">
                <img class="h-40" src="{{ asset('images/logo/sunny-baby-logo.webp') }}" alt="Logo" />
              </a>
              <p class="text-center text-gray-400 dark:text-white/60">
                پنل جامع همکاران در فروش سانی بی بی
              </p>
            </div>
          </div>
        </div>
