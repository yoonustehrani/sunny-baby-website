...
<body dir="rtl"
    ...
    <div class="flex h-full w-full overflow-hidden">
        ...
        <aside :class="sidebarToggle ? 'translate-x-0 lg:w-[90px]' : '-translate-x-full'"
            class="sidebar fixed left-0 top-0 z-9999 flex h-screen w-[290px] flex-col overflow-y-hidden border-r border-gray-200 bg-white px-5 dark:border-gray-100 dark:bg-gray-900 lg:static lg:translate-x-0">
            <!-- SIDEBAR HEADER -->
        ...
        <div class="relative flex flex-col flex-1 overflow-x-hidden overflow-y-auto">
            ...
            {{-- End - Small Device Overlay Start --}}
