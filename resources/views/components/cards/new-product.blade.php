<div class="card-product tw:bg-white! tw:p-2! tw:rounded-xl style-4 fl-item">
    ...
    <div class="card-product-info tw:px-2!">
        <a href="#" class="title link tw:text-lg tw:mx-auto tw:font-semibold">{{ $title }}</a>
        <span class="price tw:text-base tw:mx-auto tw:font-normal">{{ format_price($price) }}</span>
        <a class="tw:block tw:w-full tw:md:w-auto tw:text-sm tw:text-center tw:rounded-md tw:shadow-sm tw:border tw:border-transparent tw:duration-300 tw:hover:border-gray-700 tw:bg-sunset tw:px-2 tw:lg:px-3 tw:py-1 tw:mb-3 tw:mt-1 tw:mx-auto" href="#">@lang('QUICK ADD')</a>
