<section class="tw:flex tw:justify-center tw:mb-12">
    <div class="tw:bg-alabaster-dark tw:shadow-md tw:rounded-2xl tw:w-11/12 tw:lg:w-4/5 tw:py-8 tw:px-4">
        ...
        <div
        {{--  --}}
            class="tw:-mt-6 tw:w-full tw:px-1 tw:md:px-4 tw:md:w-4/5 tw:mx-auto tw:flex-wrap tw:flex tw:items-center tw:justify-center tw:gap-4 tw:md:gap-12 tw:py-6">
            <x-rec-item>
