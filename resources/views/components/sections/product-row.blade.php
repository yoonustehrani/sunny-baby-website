        ...
        <div class="hover-sw-nav hover-sw-2">
            <div class="swiper tf-sw-product-sell wrap-sw-over" data-preview="4" data-tablet="3" data-mobile="2" data-space-lg="30" data-space-md="15" data-pagination="2" data-pagination-md="3" data-pagination-lg="3">
                <div class="swiper-wrapper">
                    <x-product-item.card title="محصول تستی" :price="format_price(160000)"/>
                    <x-product-item.card title="محصول تستی" :price="format_price(100000)"/>
                    <x-product-item.card title="محصول تستی" :price="format_price(250000)"/>
                    <x-product-item.card title="محصول تستی" :price="format_price(770000)"/>
                    <x-product-item.card title="محصول تستی" :price="format_price(340000)"/>
                    <x-product-item.card title="محصول تستی" :price="format_price(360000)"/>
                    <x-product-item.card title="محصول تستی" :price="format_price(180000)"/>
                </div>
