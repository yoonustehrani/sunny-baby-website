@props(['product'])
<button {{ $attributes }} class="tw:disabled:text-gray-500 tw:disabled:bg-gray-300 tw:disabled:border-gray-300 tf-btn btn-fill tw:grow justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn">
    @isset($product)
        @if ($product->stock == 0)
